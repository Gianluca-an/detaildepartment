// Feature 8 from Hirael <https://hirael.com/blocks/features/feature-08>
// MIT · Mohammad Shehadeh · https://github.com/MohammadShehadeh/hirael
// SAVED AS: Detail Department — Services page layout (Hero option-independent).
// Reskin plan in NOTES.md; content below is the upstream demo, preserved verbatim.
  ...
  return (
    <svg
      ...
      className={cn(
        ...
        position === "top-start" &&
          "start-0 top-0 -translate-y-1/2 ltr:-translate-x-1/2 rtl:translate-x-1/2",
        position === "bottom-end" &&
          "bottom-0 end-0 translate-y-1/2 ltr:translate-x-1/2 rtl:-translate-x-1/2",
      )}
    >
      <path d="M5 12h14" />
      <path d="M12 5v14" />
    ...
    >
      ...
      >
        ...
        <p className="text-base leading-relaxed text-muted-foreground md:text-lg">
          The editor is the headline, but the platform underneath carries the
          boring parts: secrets, caching, retries and an API for the rest.
        </p>
      </div>
        ...
        {FEATURES.map((feature) => (
          <FeatureCard key={feature.title}>
            ...
            >
              <feature.icon
                aria-hidden
                className="size-5 stroke-[1.5] text-foreground"
              />
            </div>
