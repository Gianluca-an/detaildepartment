// Process / How-it-works — OPTION 3 (shadcn component, preserved verbatim).
// Sticky left intro column + numbered step list with a top-border per row and a
// small corner illustration. Reskin plan in NOTES.md.
