// video-text.tsx
// Reusable "video inside text" component (masks a <video> to the shape of text).
// Theme-agnostic — kept essentially as supplied. Destination: /components/ui/video-text.tsx
"use client";
...
export function VideoText({
  ...
  return (
    <Component className={cn(`relative size-full`, className)}>
      ...
      >
        <video className="h-full w-full object-cover" autoPlay={autoPlay} muted={muted} loop={loop} preload={preload} playsInline>
          <source src={src} />
